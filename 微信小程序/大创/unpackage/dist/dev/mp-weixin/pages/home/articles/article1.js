...
const _sfc_main = {
  ...
  setup(__props) {
    const article = common_vendor.ref({
      title: "长征路上的一个春节",
      paragraphs: [
        "面对敌人的围追堵截，遵义会议之后的红军依旧是危机重重，必须尽快杀出一条血路，突出重围。",
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: common_vendor.f(article.value.paragraphs, (para, index, i0) => {
          return {
            a: common_vendor.t(para),
            b: index
          };
        })
      };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-ad573227"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/home/articles/article1.js.map
